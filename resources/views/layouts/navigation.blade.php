                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        @auth
                            ...
                            @elseif (auth()->user()->hasRole('professor'))
                                <x-nav-link :href="route('professor')" :active="request()->routeIs('professor')">
                                    {{ __('Professor') }}
                                </x-nav-link>
                ...
                <div class="hidden sm:flex sm:items-center sm:ml-6">
                    @auth
                        <x-dropdown align="right" width="48">
                            <x-slot name="trigger">
                                <button
                                    class="flex items-center text-sm font-medium text-gray-500 bg-gray-300 py-2 px-4 rounded-full hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @auth
                ...
                @elseif (auth()->user()->hasRole('professor'))
                    <x-responsive-nav-link :href="route('professor')" :active="request()->routeIs('professor')">
                        {{ __('Professor') }}
                    </x-responsive-nav-link>
                @elseif (auth()->user()->hasRole('student'))
