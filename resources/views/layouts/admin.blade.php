                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        @if (auth()->user()->profile_pic)
                            <img src="{{ asset(auth()->user()->profile_pic) }}" class="img-circle elevation-2"
                                alt="User Image">
                        @else
                            <img src="{{ asset('uploads/images/avatar1.png') }}" class="img-circle elevation-2"
                                alt="User Image">
                        @endif
