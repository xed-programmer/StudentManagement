        ...
        <form method="POST" action="{{ route('admin.subject.update', $subject) }}">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <x-input id="code" class="form-control" type="text" name="code" :value="$subject->code" required />
                </div>
                ...
                <div class="form-group">
                    ...
                    <x-input id="name" class="form-control" type="text" name="name" :value="$subject->name" required />
                </div>
