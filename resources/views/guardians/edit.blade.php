                ...
                <div class="md:col-span-1">
                    <div class="px-4 sm:px-0">
                        ...
                        <p class="mt-1 text-sm text-gray-600">
                            {{ __('Use a permanent phone number where you can receive sms') }}
                        </p>
                    </div>
                </div>
                <div class="mt-5 md:mt-0 md:col-span-2">
                    <form action="{{ route('profile.guardian.update.user') }}" method="POST">
                        @csrf
                        @method('PUT')
            ...
            <div class="md:grid md:grid-cols-3 md:gap-6">
                <div class="md:col-span-1">
                    <div class="px-4 sm:px-0">
                        ...
                        <p class="mt-1 text-sm text-gray-600">
                            {{ __('Make sure that your password is longer and unique so no one can guest it') }}
                        </p>
                    </div>
                </div>
                <div class="mt-5 md:mt-0 md:col-span-2">
                    <form action="{{ route('profile.guardian.update.password') }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="shadow overflow-hidden sm:rounded-md">
                            <div class="px-4 py-5 bg-white sm:p-6">
