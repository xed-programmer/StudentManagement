...
<div class="relative bg-white overflow-hidden">
    ...
    <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
      <img class="h-56 w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full" src="https://images.pexels.com/photos/5428264/pexels-photo-5428264.jpeg?cs=srgb&dl=pexels-tima-miroshnichenko-5428264.jpg&fm=jpg" alt="">
    </div>
  </div>
